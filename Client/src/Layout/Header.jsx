...
const Header = ({showSidebar, setShowSidebar}) => {
    return (
        <div className="fixed top-0 left-0 w-full py-3 px-4  lg:px-7 z-40 lg:bg-none">
            ...
            <div onClick={() => setShowSidebar(!showSidebar)} className="cursor-pointer flex justify-center items-center  w-[40px] h-[40px] bg-[#ffffff] border border-[#fe6d3d] rounded-lg lg:hidden ml-2 ">
            <span className="material-symbols-rounded flex justify-center items-center text-[#fe6d3d]">menu</span>
            </div>
            ...
            <div className="hidden md:block w-[50%]">
                ...
                <span className="material-symbols-rounded text-[#92a2ac]">search</span>
                <input className="px-3 w-full  text-[#92a2ac] rounded-xl py-2 outline-none " type="text" name='search' placeholder='Search Product' />
                </div>
            </div>
