...
const Header = ({showSidebar, setShowSidebar}) => {
    return (
        <div className="fixed top-0 left-0 w-full py-3 px-2  lg:px-7 z-40 ">
            <div className="flex justify-between items-center ml-0 lg:ml-[250px]  h-[65px] rounded-xl lg-rounded-none">
            ...
            <div className="hidden md:block w-[50%]">
                ...
                <input className="px-3 w-full  text-[#92a2ac] focus:border-[#c8d5dd] focus:border-2 rounded-xl py-2 outline-none " type="text" name='search' placeholder='Search Product' />
                </div>
            </div>
